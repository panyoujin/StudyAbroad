...
def insert_chat():
    ...
    user_info = mysql.get_object(chat_notice_sql.select_user_info, (ReceiveUserId))
    ...
    mysql.operate_object(chat_notice_sql.insert_chat_notice, (SendUserId, system_content, SendUserId,guid,ReceiveUserId))

...
# 修改用户信息表数据
update_user_info = "UPDATE U_UserInfo SET RealName='%s',Sex=%s,Address='%s',Education='%s',Email='%s',IDCard='%s',IDCardJust='%s',IDCardBack='%s',ServiceAreaId='%s',ServiceTypeId='%s',ModifUserID='%s',ModifTime=Now()" \
                   "where UserId='%s'"
# 规划师统计表
